...
.method public static getLatLonGrid(Landroid/content/Context;Lorg/osmdroid/views/MapView;)Lorg/osmdroid/views/overlay/FolderOverlay;
    ...
    invoke-virtual {v8, v0}, Lorg/osmdroid/views/overlay/Marker;->setTitle(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v8}, Lorg/osmdroid/views/overlay/Polyline;->setWidth(F)V

    .line 227
    sget v8, Lorg/osmdroid/views/overlay/gridlines/LatLonGridlineOverlay;->lineColor:I

    invoke-virtual {v0, v8}, Lorg/osmdroid/views/overlay/Polyline;->setColor(I)V
    ...
    invoke-direct {v10, v6, v7, v4, v5}, Lorg/osmdroid/util/GeoPoint;-><init>(DD)V
    ...
    .line 233
    invoke-virtual {v0, v8}, Lorg/osmdroid/views/overlay/Polyline;->setPoints(Ljava/util/List;)V

    .line 235
    sget-boolean v8, Lorg/osmdroid/views/overlay/gridlines/LatLonGridlineOverlay;->DEBUG2:Z
    ...
    .line 243
    invoke-virtual {v0, v3}, Lorg/osmdroid/views/overlay/Marker;->setRotation(F)V
    ...
    invoke-virtual {v0, v3}, Lorg/osmdroid/views/overlay/Marker;->setTitle(Ljava/lang/String;)V
    ...
    .line 250
    invoke-virtual {v0, v3}, Lorg/osmdroid/views/overlay/Marker;->setIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-direct {v3, v6, v7, v4, v5}, Lorg/osmdroid/util/GeoPoint;-><init>(DD)V

    invoke-virtual {v0, v3}, Lorg/osmdroid/views/overlay/Marker;->setPosition(Lorg/osmdroid/util/GeoPoint;)V
    ...
    .line 268
    invoke-virtual {v0, v5}, Lorg/osmdroid/views/overlay/Marker;->setIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-direct {v11, v14, v15, v6, v7}, Lorg/osmdroid/util/GeoPoint;-><init>(DD)V
