...
.method public exists(Ljava/lang/String;Lorg/osmdroid/tileprovider/MapTile;)Z
    ...
    .line 207
    iget-object v0, v1, Lorg/osmdroid/tileprovider/modules/SqlTileWriter;->db:Landroid/database/sqlite/SQLiteDatabase;
    ...
    .line 217
    iget-object v9, v1, Lorg/osmdroid/tileprovider/modules/SqlTileWriter;->db:Landroid/database/sqlite/SQLiteDatabase;
    ...
    const-string v6, "Unable to test for tile exists cached tile from "
...
.method public remove(Lorg/osmdroid/tileprovider/tilesource/ITileSource;Lorg/osmdroid/tileprovider/MapTile;)Z
    ...
    const-string p2, ", database not available."
    ...
    const-string p2, " db is "

    invoke-virtual {p1, p2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object p1

    iget-object p2, p0, Lorg/osmdroid/tileprovider/modules/SqlTileWriter;->db:Landroid/database/sqlite/SQLiteDatabase;
